...
public class AddGantryMore extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_gantry_more);
        ...
        if (!isConnected(AddGantryMore.this)) {
            //readExcel();
            //readExcelLoadtype();
            //readExcelConType();
        } else {
            new AddGantryMore.loadProvince().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        }
        ...
        SpinnerProvince.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!Util.isConnected(AddGantryMore.this)){
                    //readExcelLine();
                    Toast.makeText(getApplication(),"readExcel1: " , Toast.LENGTH_SHORT).show();

                }else {
                    new AddGantryMore.loadAreaByProvince().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
        ...
        SpinnerArea.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!Util.isConnected(AddGantryMore.this)){
                    ...
                    new AddGantryMore.loadGantrybyArea().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
            public void onNothingSelected(AdapterView<?> parent) {
            }
...
//
//                }else {
//                    new AddGantryMore.loadGantryByLine().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
//                }
//            }
//            public void onNothingSelected(AdapterView<?> parent) {
//            }
//        });
        ...
        SpinnerGantry.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!Util.isConnected(AddGantryMore.this)){
                    ...
                    new AddGantryMore.loadGantryObj().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
            public void onNothingSelected(AdapterView<?> parent) {
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(ActivityCompat.checkSelfPermission(AddGantryMore.this,ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
                    return;
                }
                client.getLastLocation().addOnSuccessListener(AddGantryMore.this, new OnSuccessListener<Location>() {
                    @Override
        ...
        // Location Getter Map View 1
        Button MapView1 = (Button) findViewById(R.id.bLocationMap1);
        MapView1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                SessionManager obj = new SessionManager(getBaseContext());
                obj.createKeyLocButton("1");

                Intent intent = new Intent(AddGantryMore.this, LocationGetter.class);
                startActivity(intent);
            }
        });

        // Location Getter Map View 2
        Button MapView2 = (Button) findViewById(R.id.bLocationMap2);
        MapView2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                SessionManager obj = new SessionManager(getBaseContext());
                obj.createKeyLocButton("2");
        ...
        // Location Getter Map View 3
        Button MapView3 = (Button) findViewById(R.id.bLocationMap3);
        MapView3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                SessionManager obj = new SessionManager(getBaseContext());
                obj.createKeyLocButton("3");
        ...
        // Location Getter Map View 4
        Button MapView4 = (Button) findViewById(R.id.bLocationMap4);
        MapView4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                SessionManager obj = new SessionManager(getBaseContext());
                obj.createKeyLocButton("4");
        ...
        ButtonSendDB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AddGantryMore.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.apphome) {
            Intent intent = new Intent(AddGantryMore.this, MainActivity.class);
            startActivity(intent);

        } else if (id == R.id.nearby) {
            Intent intent = new Intent(AddGantryMore.this, GetNearByTower.class);
            startActivity(intent);

         ///////////////////////////////// PHM - LCM ////////////////////////////////////////////

        } else if (id == R.id.nav_addLine) {
            Intent intent = new Intent(AddGantryMore.this, AddLine.class);
            startActivity(intent);

        } else if (id == R.id.nav_addSupport) {
            Intent intent = new Intent(AddGantryMore.this, AddSupport.class);
            startActivity(intent);

        }else if (id == R.id.nav_addTowerMaintainance) {
            Intent intent = new Intent(AddGantryMore.this, TM2.class);
            startActivity(intent);

            //////////////////////////////// PHM - SUb ////////////////////////////////////////////

        } else if (id == R.id.nav_addGantry) {
            Intent intent = new Intent(AddGantryMore.this, AddGantry.class);
            startActivity(intent);

        } else if (id == R.id.nav_addBusBar) {
            Intent intent = new Intent(AddGantryMore.this, AddBusBar.class);
            startActivity(intent);

        } else if (id == R.id.nav_addStructual) {
            Intent intent = new Intent(AddGantryMore.this, AddStructural.class);
            startActivity(intent);

        } else if (id == R.id.nav_addGantryMore) {
            Intent intent = new Intent(AddGantryMore.this, AddGantryMore.class);
            startActivity(intent);
        } else if (id == R.id.nav_editGantryMore) {
            Intent intent = new Intent(AddGantryMore.this, EditGantryMore.class);
            startActivity(intent);

        } else if (id == R.id.nav_addFeeder) {
            Intent intent = new Intent(AddGantryMore.this, AddFeeder.class);
            startActivity(intent);

        } else if (id == R.id.nav_addSwitches) {
            Intent intent = new Intent(AddGantryMore.this, AddSwitches.class);
            startActivity(intent);

        } else if (id == R.id.nav_addSurge) {
            Intent intent = new Intent(AddGantryMore.this, AddSurgeArrestors.class);
            startActivity(intent);

        } else if (id == R.id.nav_addTransformersG) {
            Intent intent = new Intent(AddGantryMore.this, AddTransformersG.class);
            startActivity(intent);

        }else if (id == R.id.nav_addEquipment) {
            Intent intent = new Intent(AddGantryMore.this, AddEquipment.class);
            startActivity(intent);

         ///////////////////// POLE DETAILS //////////////////////////////////////////////

        } else if (id == R.id.nav_addMVPoles) {
            Intent intent = new Intent(AddGantryMore.this, AddMVPoles.class);
            startActivity(intent);

        } else if (id == R.id.nav_addPoles) {
            Intent intent = new Intent(AddGantryMore.this, AddPoles.class);
            startActivity(intent);

        } else if (id == R.id.nav_addTowers) {
            Intent intent = new Intent(AddGantryMore.this, AddTransformers.class);
            startActivity(intent);

        } else if (id == R.id.nav_Login) {
            Intent intent = new Intent(AddGantryMore.this, Login.class);
            startActivity(intent);
        }
        DrawerLayout drawer = findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
    ...
    private class loadAreaByProvince extends AsyncTask<String, Void, Gldeptm[]> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            ProgDialog= new ProgressDialog(AddGantryMore.this);
...
//    }
    ...
    private class AddGantryLocDB extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            ...
            String[] lati = {lati1,lati2,lati3,lati4};
            String[] longi = {longi1,longi2,longi3,longi4};
            String [] point = {"1","2","3","4"};

            System.out.println("############################### Test Intialized variable ##############################################");

            System.out.println("Latitude 1:" + lati1);
            System.out.println("Longitude 1" + longi1);
            ...
            for(i=0; i<4; i++){
                ...
                MmsGantryloc objGantryLoc = new MmsGantryloc();
                objGantryLoc.setGpsLatitude(new BigDecimal(lati[i]));
                objGantryLoc.setGpsLongitude(new BigDecimal(longi[i]));

                MmsGantrylocPK LocId = new MmsGantrylocPK();
                LocId.setGantryId(new Long(code));
                LocId.setPointId(new Long(point[i]));
                objGantryLoc.setId(LocId);

                System.out.println("Set object testing :****************************************");
                System.out.println("Latitude: "+objGantryLoc.getGpsLatitude());
                System.out.println("Longitude: "+objGantryLoc.getGpsLongitude());
                System.out.println("ID: "+objGantryLoc.getId());
                System.out.println("Gantry ID: "+LocId.getGantryId());
                System.out.println("Point ID: "+LocId.getPointId());

                final RestTemplate restTemplate = new RestTemplate();
                final String url2 = Util.SRT_URL + "MMSAddGantryLocMobile";

                restTemplate.getMessageConverters().add(new MappingJackson2HttpMessageConverter());

                String objReturn = restTemplate.postForObject(url2, objGantryLoc, String.class);
