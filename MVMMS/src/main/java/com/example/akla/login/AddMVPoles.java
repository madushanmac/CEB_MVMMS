...
public class AddMVPoles extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_mvpoles);
        ...
        poleNo = findViewById(R.id.etPoleNumber);
       ...
       // txstrutsize = findViewById(R.id.textViewStrut);
        ...
        if (!isConnected(AddMVPoles.this)) {
            readExcelArea();
            readExcelProvince();
            readExcelCsc();
        } else {
        ...
        SpinnerProvince.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                province =idprovince;
                if(!Util.isConnected(AddMVPoles.this)){
        ...
        SpinnerArea.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!Util.isConnected(AddMVPoles.this)){
                    ...
                    //         new AddMVPoles.loadGantrybyArea().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                    //         new AddMVPoles.loadGantrybyArea1().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                    //         new AddMVPoles.loadGantrybyArea2().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                    //         new AddMVPoles.loadGantrybyArea3().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
            public void onNothingSelected(AdapterView<?> parent) {
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ActivityCompat.checkSelfPermission(AddMVPoles.this,ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
                    return;
                }
                client.getLastLocation().addOnSuccessListener(AddMVPoles.this, new OnSuccessListener<Location>() {
                    @Override
        ...
        Button addstaybutton = findViewById(R.id.btnAddStay);
        ...
        Button addpolebutton = findViewById(R.id.btnAddPole);
        ...
        Button addstrutbutton = findViewById(R.id.btnAddStrut);
        ...
        Button addcircuitsbutton = findViewById(R.id.btnAddCircuits);
        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {

                {
                    ...
                    System.out.println("AddMVPoles");
                    if (poleNo.getText().toString().trim().equals("")) {
                        poleNo.setError("Should give a No !");
                        Toast.makeText(getApplicationContext(), "Should give a No !", Toast.LENGTH_SHORT).show();
                    }else {
                        AlertDialog.Builder builder = new AlertDialog.Builder(AddMVPoles.this);
...
//                    valuesFeeder[c] = obj.getName();
    ...
    private class AddmvpoleGeneral extends AsyncTask<Void, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            if (noofcircuits != null) {
                Noofcircuits = noofcircuits.getText().toString();
            }
            if (SpinnerTypeNew != null) {
        ...
        if(SpinnerStrutWorkingload != null)
...
if(SpinnerVerticlePosition != null) {
...
if(SpinnerVerticlePosition1 != null) {
...
if(SpinnerVerticlePosition2 != null) {
...
if(SpinnerVerticlePosition3 != null) {
   ...
   if(SpinnerCircuitFormation != null) {
       if (SpinnerCircuitFormation.getSelectedItem().toString().equals("Select Type")) {
           ...
           circuitformation = 3;
            ...
            if(SpinnerCrossArmType2.getSelectedItem().toString().equals("Select Type")){
                ...
                crossarmtype2=1;
            }else if(SpinnerCrossArmType2.getSelectedItem().toString().equals("Pin")){
                crossarmtype2=2;
            }else{
                crossarmtype2=3;
            }
        ...
        protected String doInBackground(Void... urls) {
            ...
            objAddgmvpole.setArea(Area);
            objAddgmvpole.setCsc(Csc);
            objAddgmvpole.setPoleNo(PoleNo);
            objAddgmvpole.setPoleHeight(new BigDecimal(PoleHeight));
            objAddgmvpole.setPoleType(new BigDecimal(PoleType));
            objAddgmvpole.setWorkingLoad(new BigDecimal(WorkingLoad));
            objAddgmvpole.setGpsLongitude(new BigDecimal(Longitude));
            objAddgmvpole.setGpsLatitude(new BigDecimal(Latitude));
            objAddgmvpole.setStrutHeight(new BigDecimal(strutHeight));
            objAddgmvpole.setStrutType(new BigDecimal(strutType));
            objAddgmvpole.setStrutWorkingLoad(new BigDecimal(strutWorkingLoad));
            objAddgmvpole.setStayType(new BigDecimal(staytype));
            objAddgmvpole.setEarthConductor(new BigDecimal(checkEarth));
            objAddgmvpole.setNoOfCct(new BigDecimal(Noofcircuits));
            System.out.println("EEEEEEEEEEEEE"+checkEarth);

            // set values for circuit object 1
            objmvpolecct.setCctSource(String.valueOf(source));
            objmvpolecct.setCctVerticlePosition(new BigDecimal(verticleposition));
            objmvpolecct.setCctFormation(new BigDecimal(circuitformation));
            objmvpolecct.setCctConductorI(new BigDecimal(conductor));
            if(String.valueOf(conductor).equals("1")){
                System.out.println("/////////////"+"Copper");
                objmvpolecct.setCctConductorIi(new BigDecimal(conductortype));
                objmvpolecct.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor).equals("2")){
                System.out.println("/////////////"+"AAAC");
                objmvpolecct.setCctConductorIi(new BigDecimal(conductortype01));
                objmvpolecct.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor).equals("3")){
                System.out.println("/////////////"+"ACSR");
                objmvpolecct.setCctConductorIi(new BigDecimal(conductortype02));
                objmvpolecct.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor).equals("4")){
                System.out.println("/////////////"+"MV ABC");
                objmvpolecct.setCctConductorIi(new BigDecimal(conductortype03));
                objmvpolecct.setCctConductorIii(new BigDecimal(conductortype04));
            }else{
                System.out.println("/////////////"+"Other");

            }
            objmvpolecct.setCctCrossArmType(new BigDecimal(crossarmtype));
            objmvpolecct.setCctCrossArmVoltage(new BigDecimal(catype));
            objmvpolecct.setCctCrossArmType2(new BigDecimal(crossarmtype11));
            objmvpolecct.setCctCrossArmVoltage2(new BigDecimal(catype11));
            objmvpolecct.setCctInsulatorVoltage(new BigDecimal(voltage));
            objmvpolecct.setInsPhase(new BigDecimal(phase));
            objmvpolecct.setCctInsulatorTypeI(new BigDecimal(insulatortype));
            objmvpolecct.setCctInsulatorTypeIi(new BigDecimal(insulatortypetype));
            objmvpolecct.setCctInsulatorVoltage2(new BigDecimal(voltage4));
            objmvpolecct.setInsPhase2(new BigDecimal(phase4));
            objmvpolecct.setCctInsulatorTypeI2(new BigDecimal(insulatortype4));
            objmvpolecct.setCctInsulatorTypeIi2(new BigDecimal(insulatortypetype4));
            objmvpolecct.setCctInsulatorVoltage3(new BigDecimal(voltage5));
            objmvpolecct.setInsPhase3(new BigDecimal(phase5));
            objmvpolecct.setCctInsulatorTypeI3(new BigDecimal(insulatortype5));
            objmvpolecct.setCctInsulatorTypeIi3(new BigDecimal(insulatortypetype5));
            objmvpolecct.setCctInsulatorVoltage4(new BigDecimal(voltage6));
            objmvpolecct.setInsPhase4(new BigDecimal(phase6));
            objmvpolecct.setCctInsulatorTypeI4(new BigDecimal(insulatortype6));
            objmvpolecct.setCctInsulatorTypeIi4(new BigDecimal(insulatortypetype6));


            // set values for circuit object 2
            objmvpolecct1.setCctSource(String.valueOf(source1));
            objmvpolecct1.setCctVerticlePosition(new BigDecimal(verticleposition1));
            objmvpolecct1.setCctFormation(new BigDecimal(circuitformation1));
            objmvpolecct1.setCctConductorI(new BigDecimal(conductor));
            if(String.valueOf(conductor1).equals("1")){
                System.out.println("/////////////"+"Copper");
                objmvpolecct1.setCctConductorIi(new BigDecimal(conductortype1));
                objmvpolecct1.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor1).equals("2")){
                System.out.println("/////////////"+"AAAC");
                objmvpolecct1.setCctConductorIi(new BigDecimal(conductortype11));
                objmvpolecct1.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor1).equals("3")){
                System.out.println("/////////////"+"ACSR");
                objmvpolecct1.setCctConductorIi(new BigDecimal(conductortype12));
                objmvpolecct1.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor1).equals("4")){
                System.out.println("/////////////"+"MV ABC");
                objmvpolecct1.setCctConductorIi(new BigDecimal(conductortype13));
                objmvpolecct1.setCctConductorIii(new BigDecimal(conductortype14));
            }else{
                System.out.println("/////////////"+"Other");

            }
            objmvpolecct1.setCctCrossArmType(new BigDecimal(crossarmtype1));
            objmvpolecct1.setCctCrossArmVoltage(new BigDecimal(catype1));
            objmvpolecct1.setCctCrossArmType2(new BigDecimal(crossarmtype22));
            objmvpolecct1.setCctCrossArmVoltage2(new BigDecimal(catype22));
            objmvpolecct1.setCctInsulatorVoltage(new BigDecimal(voltage1));
            objmvpolecct1.setInsPhase(new BigDecimal(phase1));
            objmvpolecct1.setCctInsulatorTypeI(new BigDecimal(insulatortype1));
            objmvpolecct1.setCctInsulatorTypeIi(new BigDecimal(insulatortypetype1));
            objmvpolecct1.setCctInsulatorVoltage2(new BigDecimal(voltage7));
            objmvpolecct1.setInsPhase2(new BigDecimal(phase7));
            objmvpolecct1.setCctInsulatorTypeI2(new BigDecimal(insulatortype7));
            objmvpolecct1.setCctInsulatorTypeIi2(new BigDecimal(insulatortypetype7));
            objmvpolecct1.setCctInsulatorVoltage3(new BigDecimal(voltage8));
            objmvpolecct1.setInsPhase3(new BigDecimal(phase8));
            objmvpolecct1.setCctInsulatorTypeI3(new BigDecimal(insulatortype8));
            objmvpolecct1.setCctInsulatorTypeIi3(new BigDecimal(insulatortypetype8));
            objmvpolecct1.setCctInsulatorVoltage4(new BigDecimal(voltage9));
            objmvpolecct1.setInsPhase4(new BigDecimal(phase9));
            objmvpolecct1.setCctInsulatorTypeI4(new BigDecimal(insulatortype9));
            objmvpolecct1.setCctInsulatorTypeIi4(new BigDecimal(insulatortypetype9));

            // set values for circuit object 3
            objmvpolecct2.setCctSource(String.valueOf(source2));
            objmvpolecct2.setCctVerticlePosition(new BigDecimal(verticleposition2));
            objmvpolecct2.setCctFormation(new BigDecimal(circuitformation2));
            objmvpolecct2.setCctConductorI(new BigDecimal(conductor2));
            if(String.valueOf(conductor2).equals("1")){
                System.out.println("/////////////"+"Copper");
                objmvpolecct2.setCctConductorIi(new BigDecimal(conductortype2));
                objmvpolecct2.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor2).equals("2")){
                System.out.println("/////////////"+"AAAC");
                objmvpolecct2.setCctConductorIi(new BigDecimal(conductortype21));
                objmvpolecct2.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor2).equals("3")){
                System.out.println("/////////////"+"ACSR");
                objmvpolecct2.setCctConductorIi(new BigDecimal(conductortype22));
                objmvpolecct2.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor2).equals("4")){
                System.out.println("/////////////"+"MV ABC");
                objmvpolecct2.setCctConductorIi(new BigDecimal(conductortype23));
                objmvpolecct2.setCctConductorIii(new BigDecimal(conductortype24));
            }else{
                System.out.println("/////////////"+"Other");

            }
            objmvpolecct2.setCctCrossArmType(new BigDecimal(crossarmtype2));
            objmvpolecct2.setCctCrossArmVoltage(new BigDecimal(catype2));
            objmvpolecct2.setCctCrossArmType2(new BigDecimal(crossarmtype33));
            objmvpolecct2.setCctCrossArmVoltage2(new BigDecimal(catype33));
            objmvpolecct2.setCctInsulatorVoltage(new BigDecimal(voltage2));
            objmvpolecct2.setInsPhase(new BigDecimal(phase2));
            objmvpolecct2.setCctInsulatorTypeI(new BigDecimal(insulatortype2));
            objmvpolecct2.setCctInsulatorTypeIi(new BigDecimal(insulatortypetype2));
            objmvpolecct2.setCctInsulatorVoltage2(new BigDecimal(voltage10));
            objmvpolecct2.setInsPhase2(new BigDecimal(phase10));
            objmvpolecct2.setCctInsulatorTypeI2(new BigDecimal(insulatortype10));
            objmvpolecct2.setCctInsulatorTypeIi2(new BigDecimal(insulatortypetype10));
            objmvpolecct2.setCctInsulatorVoltage3(new BigDecimal(voltage11));
            objmvpolecct2.setInsPhase3(new BigDecimal(phase11));
            objmvpolecct2.setCctInsulatorTypeI3(new BigDecimal(insulatortype11));
            objmvpolecct2.setCctInsulatorTypeIi3(new BigDecimal(insulatortypetype11));
            objmvpolecct2.setCctInsulatorVoltage4(new BigDecimal(voltage12));
            objmvpolecct2.setInsPhase4(new BigDecimal(phase12));
            objmvpolecct2.setCctInsulatorTypeI4(new BigDecimal(insulatortype12));
            objmvpolecct2.setCctInsulatorTypeIi4(new BigDecimal(insulatortypetype12));

            // set values for circuit object 4
            objmvpolecct3.setCctSource(String.valueOf(source3));
            objmvpolecct3.setCctVerticlePosition(new BigDecimal(verticleposition3));
            objmvpolecct3.setCctFormation(new BigDecimal(circuitformation3));
            objmvpolecct3.setCctConductorI(new BigDecimal(conductor3));
            if(String.valueOf(conductor3).equals("1")){
                System.out.println("/////////////"+"Copper");
                objmvpolecct3.setCctConductorIi(new BigDecimal(conductortype3));
                objmvpolecct3.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor3).equals("2")){
                System.out.println("/////////////"+"AAAC");
                objmvpolecct3.setCctConductorIi(new BigDecimal(conductortype31));
                objmvpolecct3.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor3).equals("3")){
                System.out.println("/////////////"+"ACSR");
                objmvpolecct3.setCctConductorIi(new BigDecimal(conductortype32));
                objmvpolecct3.setCctConductorIii(new BigDecimal(0));
            }else if(String.valueOf(conductor3).equals("4")){
                System.out.println("/////////////"+"MV ABC");
                objmvpolecct3.setCctConductorIi(new BigDecimal(conductortype33));
                objmvpolecct3.setCctConductorIii(new BigDecimal(conductortype34));
            }else{
                System.out.println("/////////////"+"Other");

            }
            objmvpolecct3.setCctCrossArmType(new BigDecimal(crossarmtype3));
            objmvpolecct3.setCctCrossArmVoltage(new BigDecimal(catype3));
            objmvpolecct3.setCctCrossArmType2(new BigDecimal(crossarmtype44));
            objmvpolecct3.setCctCrossArmVoltage2(new BigDecimal(catype44));
            objmvpolecct3.setCctInsulatorVoltage(new BigDecimal(voltage3));
            objmvpolecct3.setInsPhase(new BigDecimal(phase3));
            objmvpolecct3.setCctInsulatorTypeI(new BigDecimal(insulatortype3));
            objmvpolecct3.setCctInsulatorTypeIi(new BigDecimal(insulatortypetype3));
            objmvpolecct3.setCctInsulatorVoltage2(new BigDecimal(voltage13));
            objmvpolecct3.setInsPhase2(new BigDecimal(phase13));
            objmvpolecct3.setCctInsulatorTypeI2(new BigDecimal(insulatortype13));
            objmvpolecct3.setCctInsulatorTypeIi2(new BigDecimal(insulatortypetype13));
            objmvpolecct3.setCctInsulatorVoltage3(new BigDecimal(voltage14));
            objmvpolecct3.setInsPhase3(new BigDecimal(phase14));
            objmvpolecct3.setCctInsulatorTypeI3(new BigDecimal(insulatortype14));
            objmvpolecct3.setCctInsulatorTypeIi3(new BigDecimal(insulatortypetype14));
            objmvpolecct3.setCctInsulatorVoltage4(new BigDecimal(voltage15));
            objmvpolecct3.setInsPhase4(new BigDecimal(phase15));
            objmvpolecct3.setCctInsulatorTypeI4(new BigDecimal(insulatortype15));
            objmvpolecct3.setCctInsulatorTypeIi4(new BigDecimal(insulatortypetype15));

            System.out.println(" N O  O F  C I R C U I T S"+Noofcircuits);
            if(Noofcircuits.equals("1")){
                objmvpolecct.setGantryId(new BigDecimal(gantry));
                objmvpolecct.setFeederId(feeder);
                list.add(objmvpolecct);
            }else if(Noofcircuits.equals("2")){
                objmvpolecct.setGantryId(new BigDecimal(gantry));
                objmvpolecct.setFeederId(feeder);
                objmvpolecct1.setGantryId(new BigDecimal(gantry1));
                objmvpolecct1.setFeederId(feeder1);
                list.add(objmvpolecct);
                list.add(objmvpolecct1);
            }else if(Noofcircuits.equals("3")){
                objmvpolecct.setGantryId(new BigDecimal(gantry));
                objmvpolecct.setFeederId(feeder);
                objmvpolecct1.setGantryId(new BigDecimal(gantry1));
                objmvpolecct1.setFeederId(feeder1);
                objmvpolecct2.setGantryId(new BigDecimal(gantry2));
                objmvpolecct2.setFeederId(feeder2);
                list.add(objmvpolecct);
                list.add(objmvpolecct1);
                list.add(objmvpolecct2);
                ...
                objmvpolecct2.setGantryId(new BigDecimal(gantry2));
                objmvpolecct2.setFeederId(feeder2);
                objmvpolecct3.setGantryId(new BigDecimal(gantry3));
                objmvpolecct3.setFeederId(feeder3);
                list.add(objmvpolecct);
                list.add(objmvpolecct1);
                list.add(objmvpolecct2);
                list.add(objmvpolecct3);
            }else{
            ...
            objpolemodel.setMvPole(objAddgmvpole);
            objpolemodel.setMvPoleCctList(list);

            System.out.println("//////////////////////////\\\\\\\\\\\\\\\\\\\\\\\\\\\\");
            System.out.println("Area"+objAddgmvpole.getArea());
            System.out.println("CSC"+objAddgmvpole.getCsc());
            System.out.println("PoleNo"+objAddgmvpole.getPoleNo());
            System.out.println("Heigth"+objAddgmvpole.getPoleHeight());
            System.out.println("Type"+objAddgmvpole.getPoleType());
            System.out.println("Working"+objAddgmvpole.getWorkingLoad());

            final RestTemplate restTemplate = new RestTemplate();


            String url1 = Util.SRT_URL + "MMSAddPoleMVMobileNew";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_add_mvpoles_drawer, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.apphome) {
            Intent intent = new Intent(AddMVPoles.this, MainActivity.class);
            startActivity(intent);

        } else if (id == R.id.nav_addLine) {
            Intent intent = new Intent(AddMVPoles.this, AddLine.class);
            startActivity(intent);

        } else if (id == R.id.nav_addSupport) {
            Intent intent = new Intent(AddMVPoles.this, AddSupport.class);
            startActivity(intent);


        }else if (id == R.id.nav_addTowerMaintainance) {
            Intent intent = new Intent(AddMVPoles.this, TM2.class);
            startActivity(intent);


        }else if (id == R.id.nav_addEquipment) {
            Intent intent = new Intent(AddMVPoles.this, AddEquipment.class);
            startActivity(intent);


        } else if (id == R.id.nav_Login) {
            Intent intent = new Intent(AddMVPoles.this, Login.class);
            startActivity(intent);

        } else if (id == R.id.nearby) {
            Intent intent = new Intent(AddMVPoles.this, GetNearByTower.class);
            startActivity(intent);

        } else if (id == R.id.nav_addGantry) {
            Intent intent = new Intent(AddMVPoles.this, AddGantry.class);
            startActivity(intent);

        }
        else if (id == R.id.nav_addAutoRecloser) {
            Intent intent = new Intent(AddMVPoles.this, AddAutoRecloser.class);
            startActivity(intent);

        }
        else if (id == R.id.nav_addLBSABS) {
            Intent intent = new Intent(AddMVPoles.this, AddLBSABS.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(AddMVPoles.this, AddFeeder.class);
            startActivity(intent);

        } else if (id == R.id.nav_addPoles) {
            Intent intent = new Intent(AddMVPoles.this, AddMVPoles.class);
            startActivity(intent);

        } else if (id == R.id.nav_addTowers) {
            Intent intent = new Intent(AddMVPoles.this, AddTransformers.class);
            startActivity(intent);
        }
            ...
            Intent intent = new Intent(AddMVPoles.this, EditMVPoles.class);
            startActivity(intent);
        }
//        }else if (id == R.id.nav_selectMvPoleMantenance) {
//            Intent intent = new Intent(AddMVPoles.this, SelectMvPoleMaintenance.class);
//            startActivity(intent);
//        }
