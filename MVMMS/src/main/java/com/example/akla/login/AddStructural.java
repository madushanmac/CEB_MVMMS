...
public class AddStructural extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_structural);
        ...
        if (!isConnected(AddStructural.this)) {
            //readExcel();
            //readExcelLoadtype();
            //readExcelConType();
        } else {
            new AddStructural.loadProvince().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        }
        ...
        SpinnerProvince.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!Util.isConnected(AddStructural.this)){
                    //readExcelLine();
                    Toast.makeText(getApplication(),"readExcel1: " , Toast.LENGTH_SHORT).show();

                }else {
                    new AddStructural.loadAreaByProvince().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
        ...
        SpinnerArea.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!Util.isConnected(AddStructural.this)){
                    ...
                    new AddStructural.loadGantrybyArea().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
            public void onNothingSelected(AdapterView<?> parent) {
            }
...
//
//                }else {
//                    new AddStructural.loadGantryByLine().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
//                }
//            }
//            public void onNothingSelected(AdapterView<?> parent) {
//            }
//        });
        ...
        SpinnerGantry.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!Util.isConnected(AddStructural.this)){
                    ...
                    new AddStructural.loadGantryObj().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                }
            }
            public void onNothingSelected(AdapterView<?> parent) {
            }
            ...
            public void onClick(View view) {

                {
                    ...
                    if (NoOfPoles.getText().toString().trim().equals("")) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(AddStructural.this);
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if(!isConnected(AddStructural.this)){
                                            ...
                                            new AddStructural.AddStructuralDB().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    ...
    private class AddStructuralDB extends AsyncTask<Void, Void, String>{
        ...
        protected String doInBackground(Void... voids) {
            ...
            System.out.println(objAddgantry.getName());
            objAddgantry.setSeNoPoles(new BigDecimal(noPoles));
            objAddgantry.setSeOverheadEarthing(overheadEarthing);

            if(groundRes.length()==0){
                objAddgantry.setSeGroungRes(new BigDecimal(0));
            }else{
                objAddgantry.setSeGroungRes(new BigDecimal(groundRes));
            }

            if(cuConRes.length()==0){
                objAddgantry.setSeCuConRes(new BigDecimal(0));
            }else{
                objAddgantry.setSeCuConRes(new BigDecimal(cuConRes));
            }

            System.out.println("Set object testing :****************************************");
            System.out.println("PHM BRANCH:" + objAddgantry.getPhmBranch());
            System.out.println("No of Poles: "+objAddgantry.getSeOverheadEarthing());
            System.out.println("Overhead Earthing: "+objAddgantry.getSeOverheadEarthing());
            System.out.println("Ground Res: "+objAddgantry.getSeGroungRes());
            System.out.println("CU Con Res: "+objAddgantry.getSeCuConRes());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.apphome) {
            Intent intent = new Intent(AddStructural.this, MainActivity.class);
            startActivity(intent);

        } else if (id == R.id.nearby) {
            Intent intent = new Intent(AddStructural.this, GetNearByTower.class);
            startActivity(intent);

            //////////////////////////////// PHM - LCM ////////////////////////////////////////////

        } else if (id == R.id.nav_addLine) {
            Intent intent = new Intent(AddStructural.this, AddLine.class);
            startActivity(intent);

        } else if (id == R.id.nav_addSupport) {
            Intent intent = new Intent(AddStructural.this, AddSupport.class);
            startActivity(intent);

        }else if (id == R.id.nav_addTowerMaintainance) {
            Intent intent = new Intent(AddStructural.this, TM2.class);
            startActivity(intent);

            //////////////////////////////// PHM - SUb ////////////////////////////////////////////

        } else if (id == R.id.nav_addGantry) {
            Intent intent = new Intent(AddStructural.this, AddGantry.class);
            startActivity(intent);

        } else if (id == R.id.nav_addBusBar) {
            Intent intent = new Intent(AddStructural.this, AddBusBar.class);
            startActivity(intent);

        } else if (id == R.id.nav_addStructual) {
            Intent intent = new Intent(AddStructural.this, AddStructural.class);
            startActivity(intent);
        } else if (id == R.id.nav_editStructual) {
            Intent intent = new Intent(AddStructural.this, EditStructural.class);
            startActivity(intent);

        } else if (id == R.id.nav_addGantryMore) {
            Intent intent = new Intent(AddStructural.this, AddGantryMore.class);
            startActivity(intent);

        } else if (id == R.id.nav_addFeeder) {
            Intent intent = new Intent(AddStructural.this, AddFeeder.class);
            startActivity(intent);

        } else if (id == R.id.nav_addSwitches) {
            Intent intent = new Intent(AddStructural.this, AddSwitches.class);
            startActivity(intent);

        } else if (id == R.id.nav_addSurge) {
            Intent intent = new Intent(AddStructural.this, AddSurgeArrestors.class);
            startActivity(intent);

        } else if (id == R.id.nav_addTransformersG) {
            Intent intent = new Intent(AddStructural.this, AddTransformersG.class);
            startActivity(intent);

        }else if (id == R.id.nav_addEquipment) {
            Intent intent = new Intent(AddStructural.this, AddEquipment.class);
            startActivity(intent);

///////////////////// POLE DETAILS //////////////////////////////////////////////

        } else if (id == R.id.nav_addMVPoles) {
            Intent intent = new Intent(AddStructural.this, AddMVPoles.class);
            startActivity(intent);

        } else if (id == R.id.nav_addPoles) {
            Intent intent = new Intent(AddStructural.this, AddPoles.class);
            startActivity(intent);

        } else if (id == R.id.nav_addTowers) {
            Intent intent = new Intent(AddStructural.this, AddTransformers.class);
            startActivity(intent);

        } else if (id == R.id.nav_Login) {
            Intent intent = new Intent(AddStructural.this, Login.class);
            startActivity(intent);
        }
    ...
    private class loadAreaByProvince extends AsyncTask<String, Void, Gldeptm[]> {
        ...
        protected void onPreExecute() {
            ...
            ProgDialog= new ProgressDialog(AddStructural.this);
